/* global aDict, Note, isIndexInsideElement, aDeck, aTag, aAll, aModel, api, aNote, sv
...
this.txtImg(false)
  ...
  .catch((error) => {
    ...
    if (this.search || this.page) {
      ...
      if (!document.querySelector('.save')) {
        ...
        let sb = saveDiv.appendChild(document.createElement('button'))
        sb.innerHTML = 'M'
        ...
        saveDiv.oncontextmenu = async function (e) {
          e.stopPropagation()
          let si = localStorage.getItem('words') // + ` ${localStorage.getItem('wordbk')}`*/ document.querySelector('.save .w').innerText
          si = si.split(' ')
          wn(si)
        ...
        sb.ondblclick = async function (e) {
          e.stopPropagation()
          let si = localStorage.getItem('words') // + ` ${localStorage.getItem('wordbk')}`*/ document.querySelector('.save .w').innerText
          si = si.split(' ')
        ...
        sb.oncontextmenu = async function (e) {
          e.stopPropagation()
          wn(e)
  ...
  async makeElem(tt, spl, ii, splL, I, w, line, emph, ltp, tts, mns = null, y = null, elem = null, o = this.var) {
    ...
    if (this.var('del') && this.new && document.querySelectorAll('.vis')[0]) {
    ...
    if (this.var('kanji')) { //(!this.slow || this.var('fq') || (this.var('yc') && !this.var('both'))) {
...
<!--                    <div class="settings-item-description">${description}</div>-->
    ...
    const input = [
      ...
      createSettingsInputTemplate('svl', 'Save Wordd', '', '2px solid purple'),
