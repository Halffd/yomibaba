...
class AnkiNoteBuilder {
    ...
    async createNote({
        ...
        console.warn(fields,template,deckName,modelName,fields,mode,context,dictionaryEntry);
          context = this.encodeObjectStrings(context)
          dictionaryEntry = this.encodeObjectStrings(dictionaryEntry)
